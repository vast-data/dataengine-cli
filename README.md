...
```bash
curl -fsSL -o vastde https://github.com/vast-data/dataengine-cli/releases/download/v5.5.0-dev.beb2814d/vastde_darwin_arm64
chmod +x vastde
...
```bash
curl -fsSL -o vastde https://github.com/vast-data/dataengine-cli/releases/download/v5.5.0-dev.beb2814d/vastde_darwin_amd64
chmod +x vastde
sudo mv vastde /usr/local/bin
```
...
```bash
curl -fsSL -o vastde https://github.com/vast-data/dataengine-cli/releases/download/v5.5.0-dev.beb2814d/vastde_linux_amd64
chmod +x vastde
sudo mv vastde /usr/local/bin
```
...
```bash
curl -fsSL -o vastde https://github.com/vast-data/dataengine-cli/releases/download/v5.5.0-dev.beb2814d/vastde_linux_arm64
chmod +x vastde
sudo mv vastde /usr/local/bin
```
...
Download [vastde_windows_amd64.exe](https://github.com/vast-data/dataengine-cli/releases/download/v5.5.0-dev.beb2814d/vastde_windows_amd64.exe) and add it to your PATH.
